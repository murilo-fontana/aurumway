...
import dev.murilofontana.aurumway.contracts.application.port.in.TerminateContractUseCase;
...
@Service
public class TerminateContractHandler implements TerminateContractUseCase {

    private final ContractRepositoryPort repository;

    public TerminateContractHandler(ContractRepositoryPort repository) {
