...
import dev.murilofontana.aurumway.payments.adapter.out.persistence.repository.JpaAuditEventRepository;
...
public class AuditEventRepositoryAdapter implements AuditEventRepositoryPort {
    ...
    public List<AuditEvent> findWithFilters(String action, String entityType, String entityId,
        ...
        return jpa.findWithFilters(tenantId, action, entityType, entityId, actor, from, to)
                .stream()
